...
public class EurekaBootStrap implements ServletContextListener {
    ...
    protected void initEurekaServerContext() throws Exception {
        // 第一步，将eureka-server中的配置文件加载到EurekaServerConfig中
        ...
        // 第二步，创建ApplicationInfoManager
        // 每个eureka client就是一个application
        ApplicationInfoManager applicationInfoManager = null;

        if (eurekaClient == null) {
            // 把eureka-client.properties中的配置加载到EurekaInstanceConfig中
            ...
            // 把eureka-client.properties中的配置加载到EurekaClientConfig中
